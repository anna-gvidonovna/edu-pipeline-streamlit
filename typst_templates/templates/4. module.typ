...
v(1em)
  ...
  heading[Цели и задачи дисциплины]
  
  v(1em)
  heading("Цель дисциплины", level: 2)
  v(0.5em)
  [- #aim.replace(regex("^\w"), m=>{upper(m.text)})]

  

  v(1em)
  heading("Задачи дисциплины", level: 2)
  v(0.5em)
  ...
  v(2em)
  heading[Место дисциплины в структуре образовательной программы]
  v(1em)
  [Дисциплина включена в учебный план по направлению #direction, профиль "#program_name", входит в #disc_type учебного плана, и изучается в 
...
if prepared.pk.len() > 0 [
  ...
  pagebreak()
  heading[Объем дисциплины и виды учебной работы]
 ...
 heading("Тематический план изучения дисциплины", level: 2)
 v(1em)
create-discipline-content(topics, topics_abstract)
 ...
 heading[Учебно-методическое и информационное обеспечение дисциплины]
 ...
 heading[Материально-техническое обеспечение дисциплины]

 mats_tech

  pagebreak()
  
  heading[Методические рекомендации по изучению дисциплины]
  methods
}
